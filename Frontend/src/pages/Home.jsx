        ...
        <div className="max-w-[1550px] mx-auto px-6">
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 lg:col-span-3 flex flex-col gap-6 md:gap-3 lg:pr-0">
              <div className="feature-box px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-12 w-full rounded-2xl text-center">
                <p className="text-white font-bold text-[18px] md:text-[29px] lg:text-[39px] font-sansation">
                  $1 BILLION
                </p>
                <p className="text-white text-[12px] md:text-[16px] lg:text-[20px] mt-1 font-sansation">
      ...
      <section className=" flex items-center justify-center py-30">
        <div className="w-full max-w-[1550px] mx-auto relative">
          ...
          <div className="relative -mb-8 ml-4">
            <h2 className="absolute -top-8 left-0 text-[50px] md:text-[70px] font-serif italic text-red-600 opacity-90 leading-none">
              Our
            </h2>
            <h2 className="text-white text-[30px] md:text-[50px] font-bold tracking-wider">
              TESTIMONIAL
            </h2>
          </div>

          <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-0 relative">
            {/* Left White Card Section */}
            <div className="relative z-20 w-full lg:w-[55%] xl:w-[45%] lg:mt-20">
              <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl relative">
                ...
                {/* Author Info */}
                <div>
                  <h4 className="font-semibold text-[#333333] text-xl lg:text-[26px] tracking-wide">
                    STEPHEN S.
                  </h4>
            ...
            {/* Right Image Section (Overlapping) */}
          ...
          <div className="max-w-[1550px] mx-auto px-6 grid lg:grid-cols-4 md:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              ...
              <div className="space-y-3 text-sm text-gray-300 lg:max-w-[272px]">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[16px] text-white poppins-font">
                    425 246 2023
                  </span>
                </div>
            ...
            <div className="">
              <div className="feature-box p-10 text-center space-y-4 absolute lg:bottom-60 lg:right-35 lg:mb-0 mb-10 lg:w-[500px]">
                ...
                <div className="text-[#FF0808] lg:text-[70px] text-[30px] font-betterlett lg:-mt-13 -mt-9 ">
                  Power
                </div>
